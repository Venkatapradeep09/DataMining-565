...
public class InputData {
	...
	public List<DataRecord> testDataRecords;
	List<DataRecord> traindDataRecords;
	List<DataRecord> validationRecords = new ArrayList<DataRecord>();
	
	public List<DataRecord> getValidationRecords() {
		return validationRecords;
	}

	public void setValidationRecords(List<DataRecord> validationRecords) {
...
/*	private void printDataRecords(List<DataRecord> dataRecords) {
	...
	public void placeTestTrainFoldData(int i){
		...
		putValidationRecords(traindDataRecords);
...
//		printDataRecords(traindDataRecords);
	...
	private void putValidationRecords(List<DataRecord> traindDataRecords2) {
		// TODO Auto-generated method stub
		
		for( int i = 0; i< traindDataRecords2.size()/4;i++){
			validationRecords.add(traindDataRecords2.get(i));
		}
		for( int i = 0; i< traindDataRecords2.size()/4;i++){
			traindDataRecords2.remove(i);
		}
	}
